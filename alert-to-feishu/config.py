...
# ======================================= AlertManager配置 =====================================================
# AlertManager API 地址
ALERTMANAGER_URL = "http://10.21.0.65:30093"
...
P0_FEISHU_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/7517ce27-154b-418a-b21d-755a60968ec6"
P1_FEISHU_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/7517ce27-154b-418a-b21d-755a60968ec6"
P2_FEISHU_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/bd4c307c-720b-4bc5-baaf-c74f97bce707"
P3_FEISHU_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/7517ce27-154b-418a-b21d-755a60968ec6"
...
WEEK_REPORT_FEISHU_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/7517ce27-154b-418a-b21d-755a60968ec6"
...
P3_WEEKLY_REPORT_WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/7517ce27-154b-418a-b21d-755a60968ec6"
...
FIRING_FEISHU_TABLE_WEBHOOK_URL = "https://infrawaves.feishu.cn/base/automation/webhook/event/OJlQajP6UwKEjvhXL1GcAsPgnhh"
# 飞书表格告警恢复webhook，须在飞书表格自动化流程中设置，并配置webhook
RESOLV_FEISHU_TABLE_WEBHOOK_URL = "https://infrawaves.feishu.cn/base/automation/webhook/event/DZ34ar0dtwvpSWhU3tjc95nbnSb"
# 飞书通知超时时间
FEISHU_TIMEOUT = 10
...
FEISHU_APP_ID = "cli_a61ca7729fe4900b"
FEISHU_APP_SECRET = "irBjI7Hg4Ya4qpWMxTRhKeJXiR7JswC8"
...
FEISHU_URGENT_PHONE_URL = "https://open.feishu.cn/open-apis/im/v1/messages/{message_id}/urgent_phone"
# 电话通知接收人配置 (open_id) - 只有P0需要电话通知
P0_PHONE_RECEIVE_IDS = [
    "ou_e28d18eff0f2cfac318f6c39096dc520", #张阳
    "ou_eab73b8b78d23d77b6dc56330ff9f0da", #葛天昊
    "ou_e0900cc0c62cb6b1fba316a8ea75432b", #张静
    "ou_3bd4bbc8f9f3bc7b5943b4e3c993d69e", #王栋
    "ou_9d24b7bf27ffdaa965b3298b22d72065", #刘永凯
    "ou_7f722a781c891841150e105c80d7febe", #连志英
    "ou_56256fd63bf328cc888a004c85a82c6d", #梁华民
]  
